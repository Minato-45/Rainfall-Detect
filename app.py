...
logreg = LogisticRegression(random_state=0, solver='lbfgs', max_iter=5000)  # Increase iterations
...
stack3 = StackingCVRegressor(regressors=(LR, random_forest_model, gbr),  # Replace logreg with gbr
                             meta_regressor=LR, cv=12,
                             use_features_in_secondary=True,
                             store_train_meta_features=True,
                             shuffle=False,
